  ...
  return (
    <section className="pt-40 pb-24 bg-noir-profond min-h-screen">
      <div className="container-site max-w-3xl">
        ...
        <h1 className="font-cormorant font-light text-blanc-pur text-5xl mb-8">Mentions légales</h1>
        ...
        <div className="space-y-10 font-inter font-light text-gris-texte text-sm leading-relaxed">
          ...
          <div>
            <h2 className="font-cormorant font-light text-blanc-pur text-2xl mb-4">Responsabilité</h2>
            <p>
          ...
          <div>
            <h2 className="font-cormorant font-light text-blanc-pur text-2xl mb-4">Liens hypertextes</h2>
            <p>
