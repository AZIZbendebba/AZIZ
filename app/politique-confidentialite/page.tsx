  ...
  return (
    <section className="pt-40 pb-24 bg-noir-profond min-h-screen">
      <div className="container-site max-w-3xl">
        ...
        <h1 className="font-serif font-light text-blanc-pur text-5xl mb-8">
        ...
        <div className="space-y-10 font-sans font-light text-blanc-pur/60 text-sm leading-relaxed">
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Responsable du traitement</h2>
            <p>
              Solid Surface Tunisie, Zone industrielle, Tunis, Tunisie.<br />
          ...
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Données collectées</h2>
          ...
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Finalité du traitement</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Conservation des données</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Vos droits</h2>
            <p>
          ...
          <div>
            <h2 className="font-serif font-light text-blanc-pur text-2xl mb-4">Cookies</h2>
            <p>
